...
// CSE 20212, Lab 3
//
// Interface of class OvernightPackage
...
class OvernightPackage 			// interface for class OvernightPackage that inherits Package members
{
	public:
		...
		double calculateCost();		// calculates cost, which is ( normal fee + added fee ) * weight
