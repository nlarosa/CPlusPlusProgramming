...
class Package			// interface
{
	public:
		...
		virtual double calculateCost() = 0;	// pure virtual, calculates the cost of sending a package
		...
		virtual void printLabel() = 0;		// pure virtual function that is called from derived classes
	private:
